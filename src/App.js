    ...
    <React.Fragment>
        <div className="wrapper">
          <Switch>
              ...
              <Route exact path="/apply-job?id={someparams}" component={ApplyJobPage}/>
              <Route exact path="/company-detail?id={someparams}" component={CompanyProfilPage}/>
              <Route exact path="/user-profil?id={someparams}" component={UserProfilPage}/>
